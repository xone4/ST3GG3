...
هو مجموعة أدوات مفتوحة المصدر وغنية بالميزات لإخفاء المعلومات (steganography)، حيث تتيح إخفاء البيانات السرية داخل الصور والملفات الصوتية والمستندات وحزم الشبكة وغيرها — باستخدام **أكثر من 100 تقنية ترميز** عبر كل صيغ الملفات الممكنة.
